class ZCL_ZOD_SPAS1_MPC definition
  public
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_ZOD_SPAS1_MPC=============CP' ##NO_TEXT.
...
CLASS ZCL_ZOD_SPAS1_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZOD_SPAS1_SRV' ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Micrichip' iv_abap_fieldname = 'MICRICHIP' ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Sterlized' iv_abap_fieldname = 'STERLIZED' ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'AdopterIdCar' iv_abap_fieldname = 'ADOPTER_ID_CAR' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20241018192605'.                  "#EC NOTEXT
...
ls_text_element-artifact_name          = 'Micrichip'.                 "#EC NOTEXT
...
clear ls_text_element.
ls_text_element-artifact_name          = 'AdopterIdCar'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'Pet'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
